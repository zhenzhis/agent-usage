...
func TestContractVerificationReportIsOKAndPrivacySafe(t *testing.T) {
	...
	for _, name := range []string{"discovery.contract_bundle_uri", "bundle.document.openapi", "openapi.path./api/contracts/verify", "openapi.privacy", "openapi.auth_scheme", "openapi.operation_auth", "openapi.operation_admission"} {
