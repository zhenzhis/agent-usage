...
func Registry(opts Options) Catalog {
	...
	capabilities := []Capability{
		...
		},
		{
			...
			Tools:     []string{"ledger.current_budget", "ledger.start_workload", "ledger.start_run", "ledger.close_workload", "ledger.heartbeat_run", "ledger.run_liveness", "ledger.workload_timeline", "ledger.record_tool_call", "ledger.record_context", "ledger.record_artifact", "ledger.record_event", "ledger.event_schema", "ledger.integrations", "ledger.get_policy", "ledger.explain_cost", "ledger.find_similar_workloads"},
