...
func Registry(opts Options) Catalog {
	...
	capabilities := []Capability{
		...
		},
		{
			...
			Tools:     []string{"ledger.current_budget", "ledger.discovery", "ledger.contracts", "ledger.runtime_status", "ledger.start_workload", "ledger.start_run", "ledger.close_workload", "ledger.link_workloads", "ledger.heartbeat_run", "ledger.run_liveness", "ledger.workload_timeline", "ledger.workload_state", "ledger.workload_feed", "ledger.record_tool_call", "ledger.record_context", "ledger.record_artifact", "ledger.record_evaluation", "ledger.record_event", "ledger.validate_event", "ledger.event_schema", "ledger.event_examples", "ledger.adapter_contract", "ledger.adapter_conformance", "ledger.integrations", "ledger.get_policy", "ledger.policy_audit", "ledger.approval_routes", "ledger.approvals", "ledger.resolve_approval", "ledger.audit_log", "ledger.explain_cost", "ledger.find_similar_workloads"},
			Resources: []string{"agent-ledger://discovery/manifest", "agent-ledger://contracts/bundle", "agent-ledger://schema/canonical-events", "agent-ledger://schema/canonical-event-examples", "agent-ledger://integrations/catalog", "agent-ledger://integrations/adapter-contract", "agent-ledger://runtime/status", "agent-ledger://budget/current", "agent-ledger://workloads/recent", "agent-ledger://workloads/feed", "agent-ledger://policies/status", "agent-ledger://policy/approvals", "agent-ledger://policy/approval-routes"},
